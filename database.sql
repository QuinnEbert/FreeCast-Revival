...
CREATE TABLE `user` (`name` TEXT NOT NULL , `nick` TEXT NOT NULL , `pass` TEXT NOT NULL , `email` TEXT NOT NULL , `show` TEXT NOT NULL , `showdesc` TEXT NOT NULL , `slots` TEXT NOT NULL)